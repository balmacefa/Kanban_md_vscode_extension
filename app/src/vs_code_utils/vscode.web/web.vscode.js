                ...
                return {
                    ...
                    postMessage: (msg) => {
                        if (msg.cmd === 'showMessage' || msg.cmd === 'showError' || msg.cmd === 'showWarn' || msg.cmd === 'showTxt2Output') {
                            ...
                            console.log("Not Found: 'acquireVsCodeApi', run in vsCode");
                        } else {
                            console.log("Not Found: 'acquireVsCodeApi', run in vsCode");
                        }
                    },
                    setState: (key, value) => { console.log("Not Found: 'acquireVsCodeApi', run in vsCode"); },
                    getState: (key) => { console.log("Not Found: 'acquireVsCodeApi', run in vsCode"); }
                };
            }
        })();
        // message center
